...
import pagesRoutes from "ducks/_routes/pages.jsx";
...
class PagesHeader extends React.Component {
  ...
  activeRoute(routeName) {
    return this.props.location && this.props.location.pathname.indexOf(routeName) > -1;
  }
  componentDidUpdate(e) {
    if (e.location && e.history.location && e.history.location.pathname !== e.location.pathname) {
          ...
          <Hidden smDown implementation="css">
            <div className={classes.flex}>
              <Button href="#" className={classes.title} color="transparent">
                MADIF - Mantenimiento de Infaestructura
              </Button>
            </div>
          </Hidden>
          <Hidden mdUp>
